### Minimal text editor with configurable inserts and timers (MVP)

[Open online](https://sgrodnik.github.io/GymLog/)

- Simple text area with auto-saving draft (persists across sessions).
...
Primary use case: workout notes and timing - record sequences and durations of exercises.
